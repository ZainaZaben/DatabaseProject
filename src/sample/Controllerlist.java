...
@FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            ...
            if(flge){
                String q = ("Select ADMINUSER from Doner where '"+Tempssn+"'='"+rs.getString("logssn")+"'");
                PreparedStatement stt = con.prepareStatement(q);
                ResultSet rsl = stt.executeQuery();
                if(rsl.next());
                if (rsl.getString("ADMINUSER").equals("U")) {
                    ...
                    while (rslt.next()) {
                        ...
                        My_List.add(new mylist(rslt.getString(1), rslt.getString(2), rslt.getString(3), rslt.getString(4), rslt.getInt(5), type));
    ...
    public void meeting(ActionEvent event) throws IOException {
        ...
        Stage root = FXMLLoader.load(getClass().getResource("//Startup screen//src//sample"));
